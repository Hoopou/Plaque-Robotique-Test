...
public class Robot extends IterativeRobot {
	...
	public static final CANTalon1Subsystem CAN1Subsystem = new CANTalon1Subsystem();
	public static final CANTalon2Subsystem CAN2Subsystem = new CANTalon2Subsystem();
	public static final DoubleSolenoidSubsystem Solenoid = new DoubleSolenoidSubsystem();
	public static final Servo1Subsystem Servo1 = new Servo1Subsystem();
	public static final Servo2Subsystem Servo2 = new Servo2Subsystem();
	public static OI oi;
	...
	public void robotInit() {
		oi = new OI();
		chooser.addDefault("Default Auto", new CANTalon1Command());
